...
if (!class_exists('Wt_Invoice_Cta_Banner')) {
    class Wt_Invoice_Cta_Banner {
        ...
        public function add_meta_box() {
            if( !defined( 'WT_PDF_INVOICE_PLUGIN_DISPLAY_BANNER' ) ){
                add_meta_box(
                    ...
                    self::$is_bfcm_season ? ' ' : __( 'WooCommerce PDF Invoices, Packing Slips and Credit Notes', 'product-import-export-for-woo' ),
        ...
        public function render_banner() {
            ...
            <div class="wbte-cta-banner" style="position: relative;">
                <div class="wbte-cta-content">
                    ...
                    if ( self::$is_bfcm_season ) {
                        ...
                        <div class="wbte-cta-banner-features_head_div">
                            <img src="<?php echo esc_url( $wt_admin_img_path . '/pdf_invoice.svg' ); ?>" alt="<?php esc_attr_e( 'upgrade box icon', 'product-import-export-for-woo' ); ?>">
                            <h2><?php esc_html_e( 'WooCommerce PDF Invoices, Packing Slips and Credit Notes', 'product-import-export-for-woo' ); ?></h2>
                        </div>
                        <?php
                    }
                    ?>
                    ...
                    <ul class="wbte-cta-features">
                        <li><?php esc_html_e('Automatically generate PDF invoices, packing slips, and credit notes', 'product-import-export-for-woo'); ?></li>
                        <li><?php esc_html_e('Use ready-made, customizable templates to match your brand', 'product-import-export-for-woo'); ?></li>
                        <li><?php esc_html_e('Print or download invoices individually or in bulk', 'product-import-export-for-woo'); ?></li>
                        <li><?php esc_html_e('Set custom invoice numbering for better organization', 'product-import-export-for-woo'); ?></li>
                        <li class="hidden-feature"><?php esc_html_e('Customize documents fully with visual or code editors', 'product-import-export-for-woo'); ?></li>
                        <li class="hidden-feature"><?php esc_html_e('Include VAT, GST, ABN, and other tax details', 'product-import-export-for-woo'); ?></li>
                        <li class="hidden-feature"><?php esc_html_e('Add "Pay Now" link on invoices', 'product-import-export-for-woo'); ?></li>
                        <li class="hidden-feature"><?php esc_html_e('Add custom fields to any order document with ease', 'product-import-export-for-woo'); ?></li>
                    </ul>
        ...
        public function dismiss_banner() {
            ...
            if ( ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['nonce'] ) ), 'wt_dismiss_invoice_cta_banner_nonce' ) ) {
